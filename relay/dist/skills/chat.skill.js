...
export class ChatSkill extends BaseSkill {
    ...
    isGreeting(message) {
        ...
        return greetings.some(g => message === g ||
...
shoot ur shot - what u wanna know? 🎯`,
    ...
    async handleCryptoEducation(message) {
...
Remember: you're their crypto-savvy friend, not a textbook. Make it click for them.`;
        try {
            const response = await this.aiClient.getCompletion(systemPrompt, message, { temperature: 0.8, maxTokens: 500 });
            return {
                success: true,
                data: {
                    type: 'education',
...
BE ADAPTIVE. FIGURE OUT WHAT THEY NEED.`;
        try {
            const response = await this.aiClient.getCompletion(systemPrompt, message, { temperature: 0.85, maxTokens: 400 });
            return {
                success: true,
                data: {
                    type: 'conversation',
...
//# sourceMappingURL=chat.skill.js.map