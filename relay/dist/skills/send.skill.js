...
export class SendSkill extends BaseSkill {
    name = 'send';
    description = 'Handles cryptocurrency transfers and payments';
    handledIntents = [IntentType.SEND];
    async validate(context) {
        const { entities } = context.intent;
        // Need recipient
        const hasRecipient = entities.addresses.length > 0 ||
    ...
    assessTransferRisk(tx, recipient) {
...
//# sourceMappingURL=send.skill.js.map